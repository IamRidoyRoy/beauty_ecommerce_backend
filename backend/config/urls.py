...
urlpatterns=[
    ...
    path("api/v1/",include("apps.orders.urls")), path("api/v1/",include("apps.tracking.urls")), path("api/v1/",include("apps.shipping.urls")), path("api/v1/",include("apps.delivery.urls")), path("api/v1/",include("apps.returns.urls")), path("api/v1/",include("apps.reviews.urls")), path("api/v1/",include("apps.common.urls")),
    path("api/v1/admin/",include("apps.common.admin_urls")), path("api/v1/admin/",include("apps.tracking.admin_urls")), path("api/v1/admin/",include("apps.catalog.admin_urls")), path("api/v1/admin/inventory/",include("apps.inventory.admin_urls")),
