...
class ReturnTests(TestCase):
    def test_return_quantity_and_restock(self):
        ...
        order=checkout(cart=cart,customer_data={"name":"Customer","phone":user.phone,"district":"Dhaka","thana":"Dhanmondi","address":"A","label":""},shipping_method=ship,payment_method="cod",request_user=user)["order"]
