...
class CheckoutView(APIView):
    ...
    def post(self,request):
        ...
        result=checkout(cart=cart,customer_data=customer,shipping_method=v["shipping_method"],payment_method=v["payment_method"],coupon_code=v.get("coupon_code","").strip(),request_user=request.user if request.user.is_authenticated else None)
        ...
        data={"order":OrderSerializer(result["order"],context={"request":request}).data,"account_created":result["account_created"]}
