...
class RefundTests(TestCase):
    def setUp(self):
        ...
        self.order=checkout(cart=cart,customer_data={"name":"Customer","phone":self.user.phone,"district":"Dhaka","thana":"Dhanmondi","address":"A","label":""},shipping_method=ship,payment_method="card",request_user=self.user)["order"]
